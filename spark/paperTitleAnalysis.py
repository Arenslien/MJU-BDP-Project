...
if __name__=="__main__":
	...
	spark = SparkSession.builder.appName("Yearly Paper Title Analysis").getOrCreate()
	...
	# 2. Yearly(+ Monthly) Title Keyword Analysis
	
	# 2.1 Split Abstract & Word Count
	splited_df = cs_2021_full_df.withColumn("Words", split(col("Title"), " ")) \
	...
	for row in months:
		...
		top_K_keyword.write.csv(f"hdfs:///user/maria_dev/arxiv-analysis-result/2021/{row.Month}MonthTitleAnalysis.csv")
